...
import sobre_mim_foto from '../../assets/sobre_mim_foto.png';
...
export default function SobreMim() {
    return (
        ...
        <PostModelo fotocapa={fotocapa}
            titulo='Sobre Mim'
        > <h3 className={styles.subtitulo}> olá guy</h3>

            <img src={sobre_mim_foto} alt='foto minha' className={styles.fotoSobreMim} />
